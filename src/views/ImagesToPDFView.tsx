...
export const ImagesToPDFView: React.FC = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      setProcessing(prev => ({ ...prev, progress: 'Converting images to PDF...' }));
    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Convert multiple images into a single PDF document. Supported formats: JPEG, PNG, GIF, BMP, WebP. Maximum file size: 20MB per image.
        </p>
      </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-gray-600 dark:text-gray-400">
                <p className="text-lg font-medium">
                  {processing.isProcessing ? 'Processing...' : 'Drop image files here'}
                </p>
                <p className="text-sm">
                  {processing.isProcessing ? processing.progress : 'or click to browse (JPEG, PNG, GIF, BMP, WebP - max 20MB each)'}
                </p>
              </div>
            </div>
          </Dropzone>
          ...
          <Card>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex space-x-2">
                ...
                >
                  {processing.isProcessing ? processing.progress : 'Convert to PDF'}
                </Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setConversionSettings(prev => ({ ...prev, pageSize: e.target.value as 'a4' | 'letter' | 'auto' }))}
                ...
                <div className="flex space-x-4">
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => setConversionSettings(prev => ({ ...prev, orientation: e.target.value as 'portrait' | 'landscape' }))}
                      className="mr-2"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Portrait</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Landscape</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setConversionSettings(prev => ({ ...prev, quality: parseFloat(e.target.value) }))}
                  className="w-full"
                />
              </div>
            </div>
