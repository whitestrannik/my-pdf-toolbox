...
import { FileText, ImageIcon, Scissors, ScanLine, Minimize2, RotateCcw, ArrowRight, Zap, Shield, Clock } from 'lucide-react';

const tools = [
  { 
    id: 'combine', 
    name: 'Combine PDFs', 
    description: 'Merge multiple PDF files into a single document with professional quality',
    icon: FileText,
    path: '/combine',
  ...
  { 
    id: 'images-to-pdf', 
    name: 'Images to PDF', 
    description: 'Convert multiple images into a single PDF file with custom settings',
    icon: ImageIcon,
    path: '/images-to-pdf',
    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed mb-8">
          ...
          No uploads required - everything happens securely in your browser.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="flex items-center space-x-2 px-4 py-2 bg-white rounded-full shadow-sm border border-slate-200">
            ...
            <Link key={tool.id} to={tool.path} className="group">
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className={`bg-gradient-to-r ${tool.color} rounded-2xl p-3 shadow-lg group-hover:shadow-xl transition-all duration-200 group-hover:-translate-y-1`}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <ArrowRight className="w-5 h-5 text-slate-400 group-hover:text-slate-600 group-hover:translate-x-1 transition-all duration-200" strokeWidth={2} />
                    </div>
